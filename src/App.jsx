...
function App() {
  ...
  return (
    <>
        ...
        <Hero/>
        <Achivements/>
        <Loveus image='/recruitment/recruter.svg'  heading="Why recruters love us?" message=" 8 million responsive and startup-ready candidates, with all the information you need to vet them.
        ...
        <Loveus image='/recruitment/rec3.svg' heading='What we provide' message="8 million responsive and startup-ready candidates, with all the information you need to vet them.
                    Everything you need to kickstart your recruiting - get job posts, company branding, and HR tools set up within 10 minutes, for free.
                    A free applicant tracking system, or free integration with any ATS you may already use
